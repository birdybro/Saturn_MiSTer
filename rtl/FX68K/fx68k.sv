...
// Translate uaddr to nanoaddr using ROM lookup table.
// Replaces 136-entry case statement with a 256x7 ROM initialized from file.
module microToNanoAddr(
	...
	(* ram_init_file = "micro_to_nano.mem" *) reg [6:0] m2nRom[256];
	initial $readmemb("micro_to_nano.mem", m2nRom);

	assign orgAddr = { m2nRom[baseAddr], uAddr[1:0]};
